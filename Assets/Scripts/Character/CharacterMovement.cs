...
public class CharacterMovement : MonoBehaviour
{
    ...
    public delegate void MovementStateChangedDelegate(SCharacterMovementState newState, SCharacterMovementState oldState);
    ...
    public SCharacterMovementState activeMovementState { get; private set; }
    public SCharacterMovementState overrideMovementState { get; set; }
    ...
    [SerializeField] private SCharacterMovementState _defaultMovementState;
    [SerializeField] private SCharacterJumpBehaviour _jumpBehaviour;
    [SerializeField] private SCharacterOrientationControl _playerOrientationOverride;
    #endregion
    ...
    private void NotifyStateChanged(SCharacterMovementState newState, SCharacterMovementState previousState)
    {
        if (newState == null)
        {
    ...
    protected virtual void Update_Internal()
    {
        ...
        if (activeMovementState != null)
        {
            SCharacterMovementState targetState = null, previousState = null;
